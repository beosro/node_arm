...
app.get('/node_latest_armhf.deb', function (req, res) {
  res.download(__dirname + "/files/node_0.10.19-1_armhf.deb");
});
...
app.get('/node_0.10.13-1_armhf.deb', function (req, res) {
  res.download(__dirname + "/files/node_0.10.13-1_armhf.deb");
});
